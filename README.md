...
[mq-rest-admin-project](https://github.com/mq-rest-admin-project)
GitHub organization.
...
| Path | Purpose |
|---|---|
| `profile/README.md` | Org profile page — renders on the [mq-rest-admin-project landing page](https://github.com/mq-rest-admin-project) |
